...
router.post('/:id/like', postController_1.likePostById);
// Rota para obter o número de likes de uma postagem
router.get('/:id/likes', postController_1.getPostLikesById);
router.post('/:id/dislike', postController_1.removeLikeById);
